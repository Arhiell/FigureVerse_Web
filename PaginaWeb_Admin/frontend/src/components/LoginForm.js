(function(){
  function LoginForm(){
    ...
    return React.createElement("div", { className: "container" },
      React.createElement("div", { className: "title" }, "Login Administrador"),
      error ? React.createElement("div", { className: "error" }, error) : null,
      React.createElement("form", { onSubmit: handleSubmit },
        React.createElement("div", { className: "field" },
          React.createElement("label", null, "Email o usuario"),
          React.createElement("input", { type: "text", autoComplete: "username", value: identifier, onChange: (e)=>setIdentifier(e.target.value), placeholder: "admin@figureverse.com o arieldev" })
        ),
        React.createElement("div", { className: "field" },
